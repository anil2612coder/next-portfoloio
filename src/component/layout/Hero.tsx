...
function Hero() {
    ...
    <div className="flex mobile:justify-center desktop:flex-row desktop:items-center mobile:flex-col-reverse items-center w-full flex-1">
            <div className="flex flex-col z-20  text-white desktop:w-3/5 mobile:w-full mobile:text-center">
                <p className="desktop:text-[5vw] mobile:text-[8vw] font-bold text-lightcyan w-full">Hello, I&apos;m Anil Kumar</p>
                <p className="desktop:text-[3vw] mobile:text-[5vw]">a developer specializing in web applications with
                    <Typing />
                </p>
                <div className='flex mobile:hidden mt-6 justify-start w-[17vw]'><SocialMedia size={70} /></div>
            </div>
